...
public class TestAccount3 {
  ...
  /*  public static void main(String[] args) {
        ...
        //code
        SavingAccount janeSaving = new SavingAccount(500.00, 0.03);
        customer = bank.getCustomer(0);
        customer.addAccount(janeSaving);
        ...
        //code
        CheckingAccount owenCheck = new CheckingAccount(500.00);
        customer.addAccount(owenCheck);
        System.out.println("Creating the customer Tim Soley.");
        bank.addCustomer("Tim", "Soley");
        customer = bank.getCustomer(2);
        System.out.println("Creating his Checking Account with a 500.00 balance and 500.00 in overdraft protection.");
        //code
        CheckingAccount timCheck = new CheckingAccount(500.00, 500.00);
        customer.addAccount(timCheck);
        System.out.println("Creating the customer Maria Soley.");
        //code
        bank.addCustomer("Maria", "Soley");
        customer = bank.getCustomer(3);
        System.out.println("Maria shares her Checking Account with her husband Tim.");
        customer.addAccount(bank.getCustomer(2).getAccount());
